   ...
   <>
      <header className={
        ...
        <nav className='flex items-center justify-between nike-container'>
            <div className={`flex items-center text-4xl lg:text-3xl md:text-2xl sm:text-1xl xsm:text-1xl font-extrabold icon-style ${navState && "text-slate-900 transition-all duration-300"}`}>
                ShoeApp
            </div>
